...
public static class GameManagerDate 
{
    ...
    public static int Ice_Lock = 0;
    public static int Ice_Lock_money = 3000000;
    public static int Ice_LV = 0;
    public static double Ice_LVmoney = 150000;
    public static int Ice_Iteam1_LV;
    public static int Ice_Iteam2_LV;
    public static double Ice_Iteam1_LVmoney = 2000;
